  ...
  return (
    <div style={{ backgroundColor: '#fff', minHeight: '100vh' }}>
      ...
      <section style={{ backgroundColor: '#0A1628', padding: '64px 0 60px' }}>
        <div className="wrap">
          <p style={{ fontSize: 10, color: '#B8882A', fontWeight: 700, letterSpacing: '0.18em', textTransform: 'uppercase', marginBottom: 18 }}>Recognition</p>
          ...
          <p style={{ fontSize: 15, color: 'rgba(255,255,255,0.52)', lineHeight: 1.8, maxWidth: 440 }}>
