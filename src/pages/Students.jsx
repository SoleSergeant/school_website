    ...
    <div style={{ backgroundColor: '#FAFAF8', minHeight: '100vh' }}>
      ...
      <section style={{ backgroundColor: '#0D1B36', padding: '80px 24px' }}>
        <div className="wrap">
          ...
          <h1 style={{ fontFamily: 'Plus Jakarta Sans', fontWeight: 800, fontSize: 'clamp(36px, 5vw, 58px)', color: '#fff', letterSpacing: '-0.04em', lineHeight: 1.05, marginBottom: 16, maxWidth: 600 }}>
      ...
      <section style={{ backgroundColor: '#fff', borderBottom: '1px solid #E5E3DC', padding: '28px 24px' }}>
        <div className="wrap" style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          <span style={{ fontFamily: 'Plus Jakarta Sans', fontWeight: 800, fontSize: 28, color: '#111', letterSpacing: '-0.03em' }}>100%</span>
            ...
            {students.map(s => (
              <div key={s.id} style={{ backgroundColor: '#fff', padding: '28px 24px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
                  ...
                  <div>
                    <div style={{ fontFamily: 'Plus Jakarta Sans', fontWeight: 700, fontSize: 14.5, color: '#111', letterSpacing: '-0.01em' }}>{s.name}</div>
